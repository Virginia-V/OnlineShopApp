...
namespace OnlineShop.Dal.Migrations
{
    ...
    [Migration("20230206120609_AddNewIdentityTables")]
    partial class AddNewIdentityTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Domain.Auth.ApplicationRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShop.Domain.Auth.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("OnlineShop.Domain.Auth.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("OnlineShop.Domain.Auth.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineShop.Domain.Basket", b =>
                {
                    b.HasOne("OnlineShop.Domain.Auth.ApplicationUser", "ApplicationUser")
                        .WithOne("Basket")
                        .HasForeignKey("OnlineShop.Domain.Basket", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
